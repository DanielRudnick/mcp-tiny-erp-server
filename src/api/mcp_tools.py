...
TOOLS_CATALOG: List[Tool] = [
    ...
    Tool(
        ...
        description="Pesquisa produtos no catálogo do Tiny ERP",
        inputSchema={
            "type": "object",
            "properties": {
                "pesquisa": {"type": "string", "description": "Nome, código ou SKU"},
                "pagina": {"type": "integer", "default": 1},
                "situacao": {"type": "string", "enum": ["A", "I", "E"], "default": "A"},
                "gtin": {"type": "string", "description": "Código de barras"}
            },
            "required": ["pesquisa"]
        }
    ),
